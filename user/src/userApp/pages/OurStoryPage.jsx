...
// ✅ FIXED: HelmetProvider removed from here — must live at app root (main.jsx / App.jsx)
// If you haven't added it at root yet, wrap <App /> with <HelmetProvider> there.
...
const JSONLD = JSON.stringify({
  ...
  description:
    "Discover the story behind Ghar Ka Organic — homemade pickles, A2 bilona ghee, raw honey, and organic products from Uttarakhand Himalayas.",
  url: CANONICAL,
  inLanguage: "en-IN",
  isPartOf: {
    "@type": "WebSite",
  ...
  breadcrumb: {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Our Story", item: CANONICAL },
    ],
  },
});
  ...
  return (
    <>
      ...
      <Helmet>
        {/* Core */}
        <title>
          Our Story | Ghar Ka Organic — Homemade Organic Products from
          Uttarakhand
        </title>
        <meta
          name="description"
          content="Learn the story behind Ghar Ka Organic — homemade pickles, A2 bilona ghee, raw pahadi honey and cold-pressed oils from the hills of Uttarakhand. Made with tradition, delivered with care."
        />
        {/* ✅ Canonical — unique URL for this page */}
        ...
        <meta
          property="og:title"
          content="Our Story | Ghar Ka Organic — Homemade Organic Products from Uttarakhand"
        />
        <meta
          property="og:description"
          content="Homemade pickles, A2 bilona ghee, raw honey and cold-pressed oils from the hills of Uttarakhand. Made with traditional recipes, no preservatives, no shortcuts."
        />
        ...
        <meta
          ...
          content="Homemade organic products from Uttarakhand — Ghar Ka Organic"
        />
        ...
        <meta
          ...
          content="Homemade pickles, A2 bilona ghee, raw honey and cold-pressed oils from the hills of Uttarakhand."
        />
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero h1 em { color: ${C.terracotta}; font-style: italic; }
        .hero-sub {
          font-size: 1.1rem;
          color: ${C.muted};
          max-width: 520px;
        ...
        /* ── PRODUCTS ── */
        .products { max-width: 1100px; margin: 0 auto; padding: 5rem 2rem; }
        .products-header {
          display: flex;
      ...
      <div className="gko-page">
          ...
          <div className="story">
            <Reveal>
              <div className="story-img-wrap">
                <img
                  ...
                  alt="Organic farming in Uttarakhand Himalayas — Ghar Ka Organic"
                  onError={(e) => {
            ...
            <Reveal delay={150}>
              <div className="story-text">
                ...
                <p>
                  GharKaOrganic was born in the hills of Uttarakhand, where food
                  is still made with patience, care, and purity. We follow
                  traditional recipes passed down through generations — recipes
                  that were never written down, only lived.
                </p>
                <p>
          ...
          <div className="process-inner">
            <Reveal>
              ...
              <p>
                ...
                every bit of taste and nutrition. No machines that cut corners.
              </p>
            </Reveal>
        ...
        <section className="cta">
          <Reveal>
            ...
            <p>Join thousands of families who trust GharKaOrganic every day.</p>
            {/* ✅ FIXED: was /collections/all — now /collections (correct canonical) */}
